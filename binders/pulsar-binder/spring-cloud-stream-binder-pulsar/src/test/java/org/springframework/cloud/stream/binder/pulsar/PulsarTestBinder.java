...
/**
 * An {@link AbstractTestBinder} implementation for the {@link PulsarMessageChannelBinder}.
 *
 * @author Lari Hotari
 */
public class PulsarTestBinder extends
		AbstractTestBinder<PulsarMessageChannelBinder, ExtendedConsumerProperties<PulsarConsumerProperties>,
	...
	public PulsarTestBinder(PulsarClient pulsarClient, PulsarBinderConfigurationProperties pulsarBinderConfigurationProperties) {
		this.pulsarClient = pulsarClient;

		this.applicationContext = new AnnotationConfigApplicationContext(Config.class);

		PulsarTopicProvisioner provisioningProvider = new PulsarTopicProvisioner(pulsarBinderConfigurationProperties);

		PulsarMessageChannelBinder binder = new TestPulsarMessageChannelBinder(
				pulsarClient, pulsarBinderConfigurationProperties,
